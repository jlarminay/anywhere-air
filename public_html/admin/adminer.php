...
<tr><th>',lang(33),'<td><input name="auth[username]" id="username" value="c199grp00" autocapitalize="off">
<tr><th>',lang(34),'<td><input type="password" name="auth[password]">
<tr><th>',lang(35),'<td><input name="auth[db]" value="c199grp00"'?> autocapitalize="off">
</table>
