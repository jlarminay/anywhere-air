...
<head>
	...
	function show() {
	    	...
	    	$.get("pullSale.php", {}, function(data){
				$("#show").html(data);
			});
...
<body onload="show();">
	...
	<div id="wall"></div>
		...
		<div id="full" class="clearfix">
			...
			<br/>	
			<div style="background-color:#aeaeae;text-align:center;">
				<h2 style="margin:0;padding:10px;">Successful!</h2>
				<p>Your order was successful and will shipped soon. An email confirmation has been sent</p>
			</div>
